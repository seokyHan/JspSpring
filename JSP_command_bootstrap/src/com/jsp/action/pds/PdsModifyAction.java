...
public class PdsModifyAction implements Action {
	...
	// 업로드 파일 환경 설정
	final static private int MEMORY_THRESHOLD = 1024 * 1024 * 3; // 3MB
	final static private int MAX_FILE_SIZE = 1024 * 1024 * 40; // 40MB
	final static private int MAX_REQUEST_SIZE = 1024 * 1024 * 200; // 200MB
