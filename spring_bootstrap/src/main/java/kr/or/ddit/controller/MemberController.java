...
public class MemberController {
	...
	@RequestMapping("/list")
	public ModelAndView list(Criteria cri, HttpServletRequest request, ModelAndView mnv) throws SQLException{
...
//			if(1==1) throw new SQLException();
			...
			// 원래는 try-catch 없어도 에러 페이지 잘 나감 근데 왜 썼냐?
			// 에러 로그로 남기고 싶으니까 SQLException catch로 잡아주는거임(ex SQLException에서 로그남기고 싶을때)
			// advisor에서는 로그남기는거  못하니까 왜? memberService는 여기 밖에 없으니까 
	...
	@RequestMapping(method=RequestMethod.GET, value="/registForm")
	...
	@RequestMapping(method=RequestMethod.GET, value="/modifyForm")
