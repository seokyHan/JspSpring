...
public class MemberRestController {
	...
	@RequestMapping(method=RequestMethod.POST, value="/picture", produces="text/plain;charset=utf-8")
	...
	@RequestMapping(value="/getPicture", produces = "text/plain;charset=utf8")
